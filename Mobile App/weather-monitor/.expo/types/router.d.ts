...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/Development` | `/Weather` | `/_sitemap` | `/components/AirQuality` | `/components/Date` | `/components/Details` | `/components/ForecastDaily` | `/components/ForecastDailyItem` | `/components/ForecastHourly` | `/components/ForecastHourlyItem` | `/components/GaugeMeter` | `/components/Icon` | `/components/LocationData` | `/components/MainDetails` | `/components/SunDetails` | `/components/SunIndicator` | `/mainComponents/Footer` | `/mainComponents/Header`;
